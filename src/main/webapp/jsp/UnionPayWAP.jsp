...
<h1>银联WAP</h1>
<div class="div_y">
    <form id="pay" action="https://c.heepay.com/newOnlineBank/paymentUnion.do" method="post">
        ...
        <p><label class="label_w">productCode:(产品编码)</label>       <input class="label_w" type="text" name="productCode"       value="HY_B2CUNIONWAP" id="productCode"></p>
        ...
        <p><label class="label_w">key:(秘钥)</label>                   <input class="label_w" type="text" name="key"                value="e93fd0514773e78b76b37a5fb61a694a" id="key"></p>
    ...
    <button id="query" name="query" value="查询" style="float:right">订单查询</button><br><br>
