...
<h1>订单查询</h1>
<div class="div_y">
    <form id="pay" action="https://open.heepay.com/{productCode}/transQuery.do" method="post">
        ...
        <p><label class="label_w">merchantOrderNo:(商户订单号)</label>   <input class="label_w" type="text" name="merchantOrderNo" value=<%= request.getParameter("merchantOrderNo") %> ></p>
        ...
        <p><label class="label_w">productCode:(产品编码)</label>         <input class="label_w" type="text" name="productCode"       value=<%= request.getParameter("productCode") %> ></p>
