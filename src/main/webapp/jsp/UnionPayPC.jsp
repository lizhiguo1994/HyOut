...
<div class="div_y">
    <form id="pay" action="https://c.heepay.com/newOnlineBank/paymentUnion.do" method="post" target="_blank">
        ...
        <p><label class="label_w">productCode:(产品编码)</label>       <input class="label_w" type="text" name="productCode"       value="HY_B2CUNIONPC" id="productCode"></p>
        ...
        <p><label class="label_w">key:(秘钥)</label>                   <input class="label_w" type="text" name="key"                value="e07244f88b39beebdc570381c92ebe1b" id="key"></p>
