...
<div class="div_y">
    <form id="pay" action="https://open.heepay.com/aggrPay.do" method="post">
        ...
        <p><label class="label_w">subOpenid:(公众号下用户openid)</label> <input class="label_w" type="text" name="subOpenid"        value="123"></p>
        <p><label class="label_w">subAppid:(公众号AppID)</label>         <input class="label_w" type="text" name="subAppid"        value="123"></p>
