...
<div class="div_y">
    <form id="pay" action="https://c.heepay.com/quick/pc/index.do" method="post" target="_blank">
        ...
        <p><label class="label_w">productCode:(产品编码)</label>       <input class="label_w" type="text" name="productCode"       value="HY_B2CEBANKPC" id="productCode"></p>
        ...
        <p><label class="label_w">clientIp:(用户IP)</label>            <input class="label_w" type="text" name="clientIp"          value="168.168.8.8"></p>
        ...
        <p><label class="label_w">onlineType:(选择银行方式)</label>    <input class="label_w" type="text" name="onlineType"        value="hard"></p>
        <p><label class="label_w">bankId:(银行id)</label>              <input class="label_w" type="text" name="bankId"            value=""></p>
        <p><label class="label_w">bankName:(银行名称)</label>          <input class="label_w" type="text" name="bankName"           value=""></p>
        <p><label class="label_w">bankCardType:(银行卡类型)</label>    <input class="label_w" type="text" name="bankCardType"      value=""></p>
        <p><label class="label_w">key:(秘钥)</label>                   <input class="label_w" type="text" name="key"                value="91a1de7ff2f0bc567092ab5f368fab12" id="key"></p>
