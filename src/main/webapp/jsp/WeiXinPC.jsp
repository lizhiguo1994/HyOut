...
<div class="div_y">
    <form id="pay" action="https://open.heepay.com/aggrPay.do" method="post" target="_blank">
        ...
        <p><label class="label_w">tradeType:(交易类型)</label>           <input class="label_w" type="text" name="tradeType"       value="weixin_qr" id="tradeType"></p>
        ...
        <p><label class="label_w">key:(秘钥)</label>                     <input class="label_w" type="text" name="key"              value="84ffb2da28aea0e0d690beac54796aa8" id="key"></p>
