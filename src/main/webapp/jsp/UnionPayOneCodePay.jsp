    ...
    <script>
        $(function () {
            ...
            $("#query").click(function () {
                ...
                var productCode = "HY_B2CUNIONCODE";
...
<h1>银联一码付</h1>
<h4>银联一码付为使用微信、支付宝、手机浏览器等设备扫码完成银联WAP支付的一种支付方式</h4>
<div class="div_y">
    <form id="pay" action="https://c.heepay.com/newOnlineBank/preorder.do" method="post" target="_blank">
        <p><label class="label_w">merchantId:(商户号)</label>          <input class="label_w" type="text" name="merchantId"        value="101053" id="merchantId"></p>
        <p><label class="label_w">merchantOrderNo:(商户单号)</label>   <input class="label_w" type="text" name="merchantOrderNo"  value=<%= SmallTools.getDate("yyyyMMddHHmmss")+"hykj" %> id="merchantOrderNo" ></p>
        <p><label class="label_w">merchantUserId:(用户ID)</label>      <input class="label_w" type="text" name="merchantUserId"   value="zhangsan"></p>
        <p><label class="label_w">payAmount:(金额(元))</label>         <input class="label_w" type="text" name="payAmount"         value="0.11" ></p>
        ...
        <p><label class="label_w">description:(商品名称)</label>       <input class="label_w" type="text" name="description"       value="hy"></p>
        <p><label class="label_w">userIp:(用户IP)</label>              <input class="label_w" type="text" name="userIp"            value="168.168.8.8"></p>
        <p><label class="label_w">key:(秘钥)</label>                   <input class="label_w" type="text" name="key"                value="22fb8bb40221dcf492d966d6887c4f2f" id="key"></p>
