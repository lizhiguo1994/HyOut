...
<div class="div_y">
    <form id="pay" action="https://open.heepay.com/aggrPay.do" method="post">
        ...
        <p><label class="label_w">tradeType:(交易类型)</label>           <input class="label_w" type="text" name="tradeType"       value="alipay_wap" id="tradeType"></p>
        ...
        <p><label class="label_w">key:(秘钥)</label>                     <input class="label_w" type="text" name="key"              value="76bedfc3da2f49350525347732d6b1ce" id="key"></p>
